...
.\.venv\Scripts\python.exe -m pytest tests\test_opf_integration.py -v -rs
```
...
- artefatto creato: `dist\SEED\SEED.exe`;
...
pyinstaller packaging/pyinstaller/seed.spec    # → dist/SEED/SEED.exe
```
