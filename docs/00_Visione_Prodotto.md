...
La capacita di evolvere non implica che ogni istanza debba imparare le stesse
cose. **SEED non ha un catalogo finale di feature da sbloccare:** deve capire
quali capacita meritano di esistere per quella persona e quali invece non
conviene costruire, mantenere o mostrare. Un'integrazione, un tool o una
superficie nasce solo da bisogno, salienza ed evidenza specifici; per un altro
utente puo non essere mai concepita.
...
11. **Salienza prima della capability.** SEED impara, mantiene o rimuove una
    capacita solo quando il fitness per quello specifico utente giustifica
    costo, complessita, rischio e attenzione richiesta.
12. **Mai auto-espansione dell'autorita.** SEED puo attivare automaticamente una
    capability verificata soltanto entro autorita gia concesse. Nuovi account,
    scope, categorie di dati, destinazioni o tipi di effetto richiedono consenso;
    azioni irreversibili o ad alto impatto richiedono sempre conferma.

Il principio 12 non autorizza il componente generatore ad auto-promuoversi. Il
builder resta separato dalla promotion authority: l'eventuale attivazione
automatica e una decisione indipendente, deterministica, auditabile, revocabile
e limitata da un authority envelope gia approvato.
