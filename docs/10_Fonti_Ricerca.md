...
| [MCP Authorization](https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization) | specifica primaria | OAuth 2.1 per transport HTTP, discovery metadata, PKCE, audience/resource binding e gestione sicura dei token. | Connection Broker separato, nessun token passthrough e authority envelope dichiarato. |
| [MCP Security Best Practices](https://modelcontextprotocol.io/docs/tutorials/security/security_best_practices) | documentazione primaria | Confused deputy, token passthrough, SSRF, session hijacking e compromissione dei server locali sono rischi espliciti. | MCP non fidati per default, isolamento, allowlist destinazioni, test avversariali e quarantena. |
| [MCP Registry](https://modelcontextprotocol.io/registry/about) | registry/reference infrastructure | Il registry facilita discovery e metadata, ma non sostituisce la valutazione di sicurezza del server. | Discovery separata da vetting, pinning, digest, schema snapshot e drift detection. |
...
| Wiki | Uso in SEED |
|---|---|
| [Runtime Harness Adaptation](../seed-knowledge-graph/corpus/jarvis/wiki/Runtime_Harness_Adaptation.md) | Adattare contratti, skill, action realization e traiettorie. |
| [Cognitive User Model & Execution Harness](../seed-knowledge-graph/corpus/jarvis/wiki/Jarvis_Cognitive_User_Model_Execution_Harness.md) | Loop osserva-pesa-capisce-dubita-corregge-agisce-osserva effetto. |
| [User Knowledge Ontology](../seed-knowledge-graph/corpus/jarvis/wiki/Jarvis_User_Knowledge_Ontology.md) | Separazione tra fatti, pattern, ipotesi e segnali affettivi. |
| [Memory Architecture](../seed-knowledge-graph/corpus/jarvis/wiki/Jarvis_Memory_Architecture.md) | Memoria con provenance, selezione e writeback governato. |
| [Agent Harness Best Practices](../seed-knowledge-graph/corpus/jarvis/wiki/Agent_Harness_Best_Practices.md) | Determinismo prima del modello, action contract, verifica e audit. |
| [OpenHarness](../seed-knowledge-graph/corpus/jarvis/wiki/OpenHarness.md) | Harness adattabile e governato. |
| [Personal OS Thesis Direction](../seed-knowledge-graph/corpus/jarvis/wiki/Personal_OS_Thesis_Direction.md) | Trasparenza, reversibilita e controllo come qualita centrali. |
| [Personal Assistant Repo Scouting](../seed-knowledge-graph/corpus/jarvis/wiki/Personal_Assistant_Repo_Scouting.md) | Orientamento tra implementazioni esistenti. |
