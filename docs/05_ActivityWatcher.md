...
### Direzione P7: evidence engine locale

P7 puo ampliare la comprensione dei workflow, ma non rende implicita
l'osservazione ampia. Ogni nuova sorgente richiede consenso comprensibile,
indicatore visibile, revoca per sorgente, blocklist, cancellazione e retention
dichiarata.
...
-> feature locali derivate
-> WorkflowEvidence
-> aggregazione, scadenza e possibile NeedHypothesis
```

Password, token e sessioni non sono segnali utili e vengono scartati. I dati
sensibili restano locali. Se non esiste un percorso locale sicuro, il sistema
non usa quella sorgente. L'evidence engine puo sostenere un bisogno o una
frizione, ma non autorizza da solo connessioni o azioni.
